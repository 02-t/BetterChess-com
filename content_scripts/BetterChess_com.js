...
function main() {
    setTimeout(disableUserInfo, 100)
    

    if (url.indexOf("chess.com/home") > -1) {
        var checkExist2 = setInterval(function() { 
            console.log("OKOK")
            if ((document.getElementsByClassName("home-container-component")).length > 2) {
                console.log("stop")
                setTimeout(disableHomeElements, 100)
